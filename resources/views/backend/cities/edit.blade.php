...
@section('content')
    ...
    <div class="card shade mb-4">
        ...
        <div class="card-heard py-3 d-flex mx-2">
            ...
            <h6 class="m-0 font-weight-bold text-white btn btn-primary"> City {{$city->name}} </h6>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="1" {{old('status',$city->staus) == 1 ? 'selected' : ''}}> Active</option>
                        <option value="2" {{old('status',$city->staus) == 2 ? 'selected' : ''}}>In Active</option>
