...
@section('content')
    ...
    <div class="card-body">
        <form action="{{route('admin.shipping_companies.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <select name="fast" class="form-control" id="fast">
                        <option value="1" {{old('fast') == 1 ? 'selected' : ''}}> Fast</option>
                        <option value="0" {{old('fast') == 0? 'selected' : ''}}>Normal</option>
                    </select>
